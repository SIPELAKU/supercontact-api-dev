...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_product_product_name", "products", ["product_name"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "user_level",
            sa.Enum("Staff", "Manager", name="user_level_enum", native_enum=False),
    ...
    op.create_index(
        "idx_manage_user_department", "manage_users", ["department_id"], unique=False
    )
    op.create_index(
        "idx_manage_user_user_id", "manage_users", ["user_id"], unique=False
    )
    op.create_table(
        "role_permission",
        sa.Column("id", sa.UUID(), nullable=False),
