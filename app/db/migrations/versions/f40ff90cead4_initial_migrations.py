...
Revision ID: f40ff90cead4
Revises: 
Create Date: 2025-12-22 11:59:18.402827
...
def upgrade() -> None:
    ...
    sa.Column('user_level', sa.Enum('Staff', 'Supervisor', 'Manager', name='user_level_enum', native_enum=False), server_default=sa.text("'Staff'"), nullable=False),
    ...
    sa.Column('status', sa.Enum('Active', 'Inactive', 'Pending', name='user_status_enum', native_enum=False), server_default=sa.text("'Pending'"), nullable=False),
